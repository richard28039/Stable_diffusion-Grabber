...
if __name__ == '__main__':
    ...
    Sel.select_by_value("realisticVisionV20_v20.safetensors [e6415c4892]")
    ...
    Prompt.send_keys('The face feature and skin color should similar to origin, male , 8k uhd, dslr, soft lighting, high quality, film grain, Fujifilm XT3')
